...
import com.sinontech.tools.flyh.FhAIInterface;
 ...
 */
@Service("fhAiService")
public class FhAiService implements OrderService {
	...
	public JSONObject orderProduct(PageData orderInfo, PageData productInfo, PageData orderLog) throws Exception {
		...
		String resultStr = FhAIInterface.doSubscribe(phone,backUrl);
	...
	public JSONObject queryOrderStatus(PageData queryInfo) throws Exception {
		...
		JSONObject result = new JSONObject();
		String qresult = FhAIInterface.orderQuery(userPhone, orderNo);
	...
	public JSONObject queryUserPackage(PageData queryInfo,PageData productInfo) throws Exception {
		...
		salesCode = salesCode.replace("fh_", "");
		String diyResult = FhAIInterface.query(userPhone);
