 ...
 *
 */
@Service("xjMobileWithCaseService")
public class XjMobileWithCaseService implements OrderService {
	...
	public JSONObject orderProduct(PageData orderInfo, PageData productInfo, PageData orderLog) throws Exception {
		...
		if(ccode.equals("0")) {
			...
			JSONObject orderResult = XjYdInterface.unionCaseAcceptAcceptOrder(phone, salesCode, "0", "W");
