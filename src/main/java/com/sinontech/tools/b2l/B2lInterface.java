...
public class B2lInterface {
	
	private static final Logger logger = Logger.getLogger(B2lInterface.class);
 ...
 * @return
 */
public static String verifycodeSend(String phone,String productName,String productId) {
	...
	JSONObject json = HttpUtils.postMethod(B2lInterface.BASEURL+"/b2i-api/apicontroller/yunxiaoServiceCall/verifycodeSend",requestJSON.toString(),tradeOrderSeq);
 ...
 * @return
 */
public static String zhifuAndWxReseve(String phone,String phoneArea,String productName,String productId,String discountCode,
	...
	requestJSON.put("body", body);
	String tradeOrderSeq = System.currentTimeMillis()+phone;
	JSONObject json = HttpUtils.postMethod(B2lInterface.BASEURL+"/b2i-api/apicontroller/yunxiaoServiceCall/zhifubAndWxReseve",requestJSON.toString(),tradeOrderSeq);
	logger.info(json.toString());
	return json.toString();
}
/**
...
public static String yxOrderDetail(String orderId) {
	...
	JSONObject json = HttpUtils.postMethod(B2lInterface.BASEURL+"/b2i-api/apicontroller/yunxiaoServiceCall/yxOrderDetail",requestJSON.toString(),tradeOrderSeq);
	logger.info(json.toString());
	return json.toString();
}
public static String syncCollectContactInfoToAgent(String phone,String salerNo,String evtCollectTime,String activityCode) {
	...
	if(phoneCode.equals("0000")) {
		...
		if(resultCode.equals("0")) {
			...
			requestJSON.put("head", header);
			String tradeOrderSeq = System.currentTimeMillis()+phone;
			result = HttpUtils.postMethod(B2lInterface.BASEURL+"/b2i-api/apicontroller/iqcbroadbandController/syncCollectContactInfoToAgent",requestJSON.toString(),tradeOrderSeq);
...
public static String prodList(String phone) {
	...
	requestJSON.put("head", header);
	String tradeOrderSeq = System.currentTimeMillis()+phone;
	JSONObject json = HttpUtils.postMethod(B2lInterface.BASEURL+"/b2i-api/apicontroller/uopCustBaseService/prodList",requestJSON.toString(),tradeOrderSeq);
	logger.info(json.toString());
	return json.toString();
}
